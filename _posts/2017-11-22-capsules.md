...
{% include figure image_path="/assets/images/capsules/converge.png" alt="EM convergence." caption="The output capsules converge toward the correct classes over the three iterations of EM. [Source](https://openreview.net/pdf?id=HJWLfGWRb)." %}
